# 🛡️ CyberOS Ultimate v3.0

**CyberOS** هي أداة شاملة ومتقدمة لفحص الشبكات، جمع المعلومات (Reconnaissance)، والتحليل الجنائي للأنظمة، مصممة خصيصاً للعمل بكفاءة عالية على بيئة Termux و Linux.

---

## ✨ المميزات الرئيسية (Features)
- ⚡ **Multi-Threaded Port Scanner:** فحص متوازي وسريع للمنافذ والخدمات.
- 🌐 **Web Intelligence & Recon:** استكشاف Subdomains، فحص DNS/WHOIS، وكشف تقنيات Sites & SSL Inspection.
- 🔐 **Cryptography & Hashes:** تشفير وفك تشفير الملفات مع تجزئة النصوص والملفات.
- 🖼️ **Forensics & Steganography:** استخراج بيانات EXIF من الصور وإخفاء النصوص داخل الملفات.
- 🔑 **Password Security:** توليد كلمات سر معقدة واختبار قوتها.
- 📱 **QR Tools:** توليد وحفظ رموز الاستجابة السريعة (QR) مباشرة من الـ Terminal.
- 📊 **CLI Quick Scan & HTML Reports:** دعم تشغيل الفحص السريع عبر السطر البرمجي وإخراج تقارير تفاعلية بصيغة HTML.
...
```bash
# استنساخ المستودع
git clone [https://github.com/shenoudasameh199-hue/CyberOS.git](https://github.com/shenoudasameh199-hue/CyberOS.git)
cd CyberOS

# تثبيت المتطلبات
pip install -r requirements.txt

# التشغيل التفاعلي (القوائم)
python main.py

# التشغيل السريع المباشر (Direct Scan)
python main.py --scan example.com
git commit -m "Update README to v3.0"
scan example.com
heredoc>git push
cd ~/CyberOS
...
**CyberOS** هي أداة شاملة ومتقدمة لفحص الشبكات، جمع المعلومات (Reconnaissance)، والتحليل الجنائي للأنظمة الميدانية، مصممة خصيصاً للعمل بكفاءة عالية على بيئة Termux و Linux.
